...
namespace Framework.Cache.Desktop
{
    public class DesktopStorage : IStorage
    {
        ...
        private void Init()
        {
            _storageLocation = String.Format(CultureInfo.InvariantCulture, @"{0}\WinCache\cache\{1}", Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), _cacheName);
