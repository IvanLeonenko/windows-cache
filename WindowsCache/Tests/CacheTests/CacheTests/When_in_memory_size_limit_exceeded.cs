...
{
    [TestClass]
    public class When_in_memory_size_limit_exceeded
    {
        ...
        public void Initialize()
        {
            ...
            var cacheConfiguration = new CacheConfiguration(1024, 5, 700, 5, 1024);
        ...
        [TestMethod]
        public void cache_should_have_in_memory_size_554_bytes()
        {
            _cache.GetSize(true).Should().Be(554);
        }

        [TestMethod]
        public void cache_should_have_size_706_bytes()
        {
            _cache.GetSize().Should().Be(706);
        }

        [TestMethod]
        public void in_memory_cache_entries_quantity_should_be_4()
        {
            _cache.Count(true).Should().Be(4);
        }
